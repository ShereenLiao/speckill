...
CREATE TABLE `tb_user_info`  (
                                 ...
                                 `introduce` varchar(128) COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '个人介绍，不要超过128个字符',
...
CREATE TABLE `tb_blog`  (
                            ...
                            `liked` int(8) UNSIGNED NULL DEFAULT 00000000,
...
INSERT INTO `tb_blog` VALUES (6, 10, 1, '杭州周末好去处｜💰50就可以骑马啦🐎', '/imgs/blogs/blog1.jpg', '杭州周末好去处｜💰50就可以骑马啦🐎', 00000011, 00000000);
INSERT INTO `tb_blog` VALUES (7, 10, 1, '杭州周末好去处｜💰50就可以骑马啦🐎', '/imgs/blogs/blog1.jpg', '杭州周末好去处｜💰50就可以骑马啦🐎', 00000011, 00000000);
...
CREATE TABLE `tb_user`  (
                            ...
                            `nickname` varchar(32) NULL DEFAULT '' COMMENT '昵称，默认是用户id',
...
INSERT INTO `tb_user` VALUES (1, '13686869696', '', '小鱼同学', '/imgs/blogs/blog1.jpg', '2021-12-24 10:27:19', '2022-01-11 16:04:00'),
                             (2, '13838411438', '', '可可今天不吃肉', '/imgs/icons/kkjtbcr.jpg', '2021-12-24 15:14:39', '2021-12-28 19:58:04'),
                            (4, '13456789011', '', 'user_slxaxy2au9f3tanffaxr', '', '2022-01-07 12:07:53', '2022-01-07 12:07:53'),
                            (5, '13456789001', '', 'user_n0bb8mwwg4', '', '2022-01-07 16:11:33', '2022-01-07 16:11:33');
...
CREATE TABLE `tb_voucher`  (
                               ...
                               `stock` bigint(20) UNSIGNED NOT NULL COMMENT 'stock',
                               `begin_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'start 时间',
                               `end_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP  COMMENT 'end 时间',
                               PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `tb_voucher` VALUES (1, 1, '50元代金券', '周一至周日均可使用', '全场通用\\n无需预约\\n可无限叠加\\不兑现、不找零\\n仅限堂食', 4750, 5000, 0, 1, 10, '2022-03-04 09:42:39', '2023-06-04 09:43:31'),
                                (2, 1, '30元代金券', '周一至周日均可使用', '全场通用\\n无需预约\\n可无限叠加\\不兑现、不找零\\n仅限堂食', 4750, 5000, 0, 1, 20, '2022-03-04 09:42:39', '2023-06-04 09:45:31'),
                                (3, 2, '30元代金券', '周一至周日均可使用', '全场通用\\n无需预约\\n可无限叠加\\不兑现、不找零\\n仅限堂食', 4750, 5000, 0, 1, 20, '2022-03-04 09:42:39', '2023-06-04 09:46:31');
-- ----------------------------
